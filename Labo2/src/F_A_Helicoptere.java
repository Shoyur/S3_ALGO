...
public class F_A_Helicoptere extends F_Aerien {
    
    private int nombreHelices;
    private boolean treuilSecours;
    private boolean mitraillette;

    public F_A_Helicoptere(int numeroSerie, String fabricant, Date dateFabrication, int altituteMax, int pousseeAxiale,
