...
public class F_T_Camion extends F_Terrestre {
    
    private String DieselEssence;
    private int nombreEssieux;
    private int chargeMaximale;
    
    public F_T_Camion(int numeroSerie, String fabricant, Date dateFabrication, String gasPneus, boolean attacheRemorque,
